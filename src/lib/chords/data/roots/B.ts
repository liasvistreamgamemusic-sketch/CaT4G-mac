...
// Bルートの基本コード（31品質）
export const B_BASIC: RootChordData = {
  // ============================================
  // 基本 (5種)
  // ============================================
  ...
  'add9': [
    ...
    {
      // Badd9-high: 4弦ルートの高位ポジション
      // 1弦(E=4)+9=1 (C#) 9th, 2弦(B=11)+7=6 (F#) 5th
      // 3弦(G=7)+8=3 (D#) M3, 4弦(D=2)+9=11 (B) root
      id: 'Badd9-high',
      frets: [9, 7, 8, 9, null, null],
  ...
  // 5弦ルート移動フォーム (5弦2フレット = B)
  '69': [
    {
      id: 'B69-A',
      frets: [2, 2, 1, 1, 2, null],
